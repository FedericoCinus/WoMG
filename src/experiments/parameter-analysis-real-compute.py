import sys
sys.path = ['/home/corradom/projects/WoMG-real-data/src'] + sys.path
import datetime
import pandas as pd
import os
...
god_node_strength = 0
int_mode = 'nmf'   
graph_path = '/home/corradom/projects/WoMG-real-data/data/graph/digg/graph_filtered.csv'
...
single_activators = (False, )  # Digg is not single activator
infl_strengths = [None]
